...
public class DepthTexture extends Depth {
	...
	public void bind(ShaderProgram s) {
		...
		gl.glActiveTexture(GL4.GL_TEXTURE2);
		gl.glBindTexture(GL4.GL_TEXTURE_2D, getId());
		gl.glUniform1i(gl.glGetUniformLocation(s.getPgrmId(), unitName), 2);
	}
	...
	public void bind(ShaderProgram s, String name) {
		...
		gl.glActiveTexture(GL4.GL_TEXTURE2);
		gl.glBindTexture(GL4.GL_TEXTURE_2D, getId());
		gl.glUniform1i(gl.glGetUniformLocation(s.getPgrmId(), name), 2);
	}
	...
	public void bindToFrameBuffer() {
		gl.glFramebufferTexture2D(GL4.GL_FRAMEBUFFER, GL4.GL_DEPTH_ATTACHMENT, GL4.GL_TEXTURE_2D, getId(), 0);
	}
}
